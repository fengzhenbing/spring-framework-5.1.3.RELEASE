...
public class AnnotationAwareAspectJAutoProxyCreator extends AspectJAwareAdvisorAutoProxyCreator {//feng 注解支持的 代理创建者
	...
	protected List<Advisor> findCandidateAdvisors() {
		...
		List<Advisor> advisors = super.findCandidateAdvisors();//feng 先找到父类即xml配置的advisor
		// Build Advisors for all AspectJ aspects in the bean factory.
		if (this.aspectJAdvisorsBuilder != null) {
			advisors.addAll(this.aspectJAdvisorsBuilder.buildAspectJAdvisors());//feng AspectJ 的注解的advisor
		}
		return advisors;
	}

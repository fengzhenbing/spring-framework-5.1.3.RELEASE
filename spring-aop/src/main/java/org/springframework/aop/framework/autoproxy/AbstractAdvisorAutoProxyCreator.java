...
public abstract class AbstractAdvisorAutoProxyCreator extends AbstractAutoProxyCreator {
	...
	protected Object[] getAdvicesAndAdvisorsForBean(
		...
		List<Advisor> advisors = findEligibleAdvisors(beanClass, beanName);//feng
		if (advisors.isEmpty()) {
			return DO_NOT_PROXY;
		}
	...
	protected List<Advisor> findEligibleAdvisors(Class<?> beanClass, String beanName) {
		List<Advisor> candidateAdvisors = findCandidateAdvisors();//feng  找到候选的所有advisor
		List<Advisor> eligibleAdvisors = findAdvisorsThatCanApply(candidateAdvisors, beanClass, beanName);//feng  找到匹配的advisor
		extendAdvisors(eligibleAdvisors);
		if (!eligibleAdvisors.isEmpty()) {
			eligibleAdvisors = sortAdvisors(eligibleAdvisors);//feng 排序
		}
	 ...
	 */
	protected List<Advisor> findAdvisorsThatCanApply(//feng  找到匹配的advisor

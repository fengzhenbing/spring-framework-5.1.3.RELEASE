...
class CglibAopProxy implements AopProxy, Serializable {
	...
	@Override
	public Object getProxy(@Nullable ClassLoader classLoader) {//feng 返回代理对象
		...
		try {
			...
			Enhancer enhancer = createEnhancer();//feng cglib代理创建
			if (classLoader != null) {
	...
	private static class DynamicAdvisedInterceptor implements MethodInterceptor, Serializable {
		...
		public Object intercept(Object proxy, Method method, Object[] args, MethodProxy methodProxy) throws Throwable {
			...
			try {
				...
				List<Object> chain = this.advised.getInterceptorsAndDynamicInterceptionAdvice(method, targetClass);//feng 找到和method方法匹配的advice
				Object retVal;
				...
				if (chain.isEmpty() && Modifier.isPublic(method.getModifiers())) {
					...
					// We need to create a method invocation...  //feng 下面通过责任链模式 去进行advice增强
